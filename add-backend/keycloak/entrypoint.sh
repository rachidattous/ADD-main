...
# echo "========================================================================="
# echo ""
# echo "  COPY /custom to /opt/jboss/keycloak/themes/custom/"
# echo ""
# echo "========================================================================="
# echo ""

# cp -rf /custom /opt/jboss/keycloak/themes/ 
# cp -rf /custom-ens /opt/jboss/keycloak/themes/ 

##################
# Start Keycloak #
##################

exec /opt/jboss/keycloak/bin/standalone.sh -Djboss.http.port=8180 $SYS_PROPS $@
exit $?
